...
_atDEF_R13RetrigValue		equ #FE
        ...
        ; Added by utopian to have a simple SFX interface
        jp atInit              ;Call Player = Initialise song (DE = Song address).
        jp atPlay              ;Call Player + 3 = Play song.
        jp atStop              ;Call Player + 6 = Stop song.
        jp atSfxInit           ;Call Player + 9 to initialise the sound effect music.
        jp atSfxPlay           ;Call Player + 12 to play an effect
        jp atSfxStopAll        ;Call Player + 15 to stop all sound effects.
...
;Register 7
    ...
    and $bf            ; bit 6 must be 0
    or $80              ; bit 7 must be 1
	out (#a1),a
