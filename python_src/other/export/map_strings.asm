...
string0:	 db 'JARKUM, VE A LA FORTALEZA DE KASHGAR. BUSCA LOS MONOLITOS, Y ESCUCHA LA VOZ DE NUESTROS ANTEPASADOS.',0
string1:	 db 'ESCUCHA Y APRENDE. DAL GURAK, EL ENEMIGO, A QUIEN TUS ANTEPASADOS CREYERON DERROTADO, HA RESURGIDO DE LAS TINIEBLAS Y SE HACE FUERTE DE NUEVO. DEBES SEGUIR LOS PASOS DE TUKARAM Y RECLAMAR LA ESPADA DE IANNA, QUE EN SU D>A LE FUE CONCEDIDA POR LA DIOSA. ES LA "NICA FORMA DE DEVOLVER AL ENEMIGO AL INFIERNO QUE NUNCA DEBI; ABANDONAR. VE A LAS TUMBAS DE EPHYRA, ALL> TE SER% REVELADO EL CAMINO A TU DESTINO.',0
