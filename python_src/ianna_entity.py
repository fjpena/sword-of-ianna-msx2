...
class IannaCharacter(IannaEntity):
	...
	def __init__ (self, name , currentmap, entity_array, scorearea, player_weapons, player=False, secondary=False):
	  """ 
	  Initialize. Params:
	  ...
	  if name in ('golem', 'ogro', 'minotauro', 'demonio'):
		doublesize = True
	  else:
	  	doublesize = False

	  self.sp_idle = MSXSprite("sprites/"+name+"/"+name+suffix, 'idle', doublesize=doublesize, secondary=secondary)
	  self.sp_turn = MSXSprite("sprites/"+name+"/"+name+suffix, 'gira', doublesize=doublesize, secondary=secondary)
	  self.sp_walk = MSXSprite("sprites/"+name+"/"+name+suffix, 'camina', doublesize=doublesize, secondary=secondary)
	  self.sp_fall = MSXSprite("sprites/"+name+"/"+name+suffix, 'cae', doublesize=doublesize, secondary=secondary)
	  self.sp_crouch = MSXSprite("sprites/"+name+"/"+name+suffix, 'agacha', doublesize=doublesize, secondary=secondary)
	  self.sp_unsheathe = MSXSprite("sprites/"+name+"/"+name+suffix, 'saca_espada', doublesize=doublesize, secondary=secondary)
	  self.sp_idle_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'idle_espada', doublesize=doublesize, secondary=secondary)
	  self.sp_walk_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'camina_espada', doublesize=doublesize, secondary=secondary)
	  self.sp_high_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_golpealto', doublesize=doublesize, secondary=secondary)
	  self.sp_forw_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_golpeadelante', doublesize=doublesize, secondary=secondary)
	  self.sp_combo1_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_comboadelante', doublesize=doublesize, secondary=secondary)
	  self.sp_low_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_golpebajo', doublesize=doublesize, secondary=secondary)
	  self.sp_back_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_golpeatras', doublesize=doublesize, secondary=secondary)
	  self.sp_block_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_bloquea', doublesize=doublesize, secondary=secondary)
	  self.sp_ouch_sword = MSXSprite("sprites/"+name+"/"+name+suffix, 'espada_ouch', doublesize=doublesize, secondary=secondary)
	  self.sp_die = MSXSprite("sprites/"+name+"/"+name+suffix, 'muere', doublesize=doublesize, secondary=secondary)
	  self.sp_idle.flip()
  	  self.sp_turn.flip()
	  self.sp_walk.flip()
	  self.sp_fall.flip()
	  ...
	  if (player==True):
		...
		self.sp_ouch=MSXSprite("sprites/"+name+"/"+name+suffix, 'ouch')
		self.sp_jump_up=MSXSprite("sprites/"+name+"/"+name+suffix, 'salta')
		self.sp_shortjump=MSXSprite("sprites/"+name+"/"+name+suffix, 'salto_corto')
		self.sp_longjump=MSXSprite("sprites/"+name+"/"+name+suffix, 'salto_largo')
		self.sp_run=MSXSprite("sprites/"+name+"/"+name+suffix, 'corre')
		self.sp_brake=MSXSprite("sprites/"+name+"/"+name+suffix, 'frena')
		self.sp_braketurn=MSXSprite("sprites/"+name+"/"+name+suffix, 'frena_gira')
		self.sp_switch=MSXSprite("sprites/"+name+"/"+name+suffix, 'palanca')
		self.sp_grab=MSXSprite("sprites/"+name+"/"+name+suffix,'cuelga')
		self.sp_ouch.flip()
	...
	def load_weapon(self):
		...
		if weapon_name == 'espada':
			...
			weapon_suffix = "_%s" % weapon_name
			suffix = '02.bmp'

		self.sp_idle_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "idle_espada"+weapon_suffix)
		self.sp_walk_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "camina_espada"+weapon_suffix)
		self.sp_high_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_golpealto"+weapon_suffix)
		self.sp_forw_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_golpeadelante"+weapon_suffix)
		self.sp_combo1_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_comboadelante"+weapon_suffix)
		self.sp_low_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_golpebajo"+weapon_suffix)
		self.sp_back_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_golpeatras"+weapon_suffix)
		self.sp_block_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_bloquea"+weapon_suffix)
		self.sp_ouch_sword = MSXSprite("sprites/barbaro/barbaro"+suffix, "espada_ouch"+weapon_suffix)
...
#		print self.posx, deltax, self.posy
	...
	enemy_attack_patterns = {"OBJECT_ENEMY_SKELETON": [
			...
			"ACTION_MOVE, 80, 1, ACTION_WAIT, 3, ACTION_MOVE, 144, 1, ACTION_WAIT, 3, ACTION_MOVE, 17, 1, ACTION_WAIT, 20, ACTION_RETURN_SUBSCRIPT",
			"ACTION_TELEPORT_ENEMY, 16, 112, ACTION_WAIT, 8, ACTION_MOVE, 8, 1, ACTION_WAIT, 2, ACTION_MOVE, 32, 1, ACTION_WAIT, 2, ACTION_MOVE, 17, 1, ACTION_MOVE_OBJECT, 105, 0, 5, 1, ACTION_MOVE_OBJECT, 105, 1, 0, 8,  ACTION_MOVE_OBJECT, 105, -1, 0, 9, ACTION_MOVE_OBJECT, 105, 1, -5, 1, ACTION_RETURN_SUBSCRIPT",
			],
